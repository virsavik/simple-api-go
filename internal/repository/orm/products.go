...
var ProductWhere = struct {
	...
	Amount:      whereHelperint{field: "\"products\".\"amount\""},
	Slot:        whereHelperint{field: "\"products\".\"slot\""},
...
func (r *productR) GetInvoiceProducts() InvoiceProductSlice {
	if r == nil {
		return nil
	}
...
var (
	productAllColumns            = []string{"id", "name", "description", "amount", "slot", "created_at", "updated_at"}
	productColumnsWithoutDefault = []string{"name", "amount", "slot"}
	productColumnsWithDefault    = []string{"id", "description", "created_at", "updated_at"}
...
func (o *Product) InvoiceProducts(mods ...qm.QueryMod) invoiceProductQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"invoice_product\".\"product_id\"=?", o.ID),
	)
...
func (productL) LoadInvoiceProducts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
	...
	query := NewQuery(
		...
		qm.WhereIn(`invoice_product.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Product) AddInvoiceProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*InvoiceProduct) error {
	var err error
